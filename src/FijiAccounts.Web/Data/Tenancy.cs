...
public enum OrganisationRole { Owner, Administrator, Accountant, Bookkeeper, Payroll, Sales, ReadOnly, Approver, ReceiptsOnly }
...
public sealed class Organisation
{
    ...
    public bool RequireTradePaymentDocuments { get; set; }
