...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options)
{
    ...
    public DbSet<OrganisationCurrency> OrganisationCurrencies => Set<OrganisationCurrency>();
    public DbSet<TransactionExchangeRate> TransactionExchangeRates => Set<TransactionExchangeRate>();
    ...
    public DbSet<YearEndReviewAttachment> YearEndReviewAttachments =>
        Set<YearEndReviewAttachment>();
...
public DbSet<RecurringSupplierBillGeneration> RecurringSupplierBillGenerations =>
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<OrganisationBranding>()
            .HasKey(x => x.OrganisationId);
        builder.Entity<OrganisationBranding>()
            .HasOne(x => x.Organisation)
            .WithOne()
            .HasForeignKey<OrganisationBranding>(x => x.OrganisationId)
            .OnDelete(DeleteBehavior.Cascade);
        builder.Entity<OrganisationCurrency>()
        ...
        builder.Entity<OrganisationCurrency>()
            ...
            .OnDelete(DeleteBehavior.Cascade);
        builder.Entity<TransactionExchangeRate>()
            .HasIndex(x => new { x.OrganisationId, x.FromCurrency, x.ToCurrency, x.EffectiveDate })
            .IsUnique();
        builder.Entity<TransactionExchangeRate>()
            .Property(x => x.Rate)
            .HasPrecision(18, 8);
        ...
        builder.Entity<YearEndReviewAttachment>()
            .HasIndex(x => new { x.OrganisationId, x.YearEndReviewItemId });
        builder.Entity<YearEndReviewAttachment>()
            .HasOne(x => x.YearEndReviewItem)
            .WithMany(x => x.Attachments)
            .HasForeignKey(x => x.YearEndReviewItemId)
            .OnDelete(DeleteBehavior.Restrict);
        builder.Entity<YearEndReviewAttachment>()
            .HasOne(x => x.ImmutableDocumentObject)
            .WithMany()
        ...
        builder.Entity<SalesInvoice>().Property(x => x.TransactionAmountPaid).HasPrecision(18, 2);
        ...
        builder.Entity<SalesInvoice>().Property(x => x.ExchangeRateToBase).HasPrecision(18, 8);
        builder.Entity<SalesInvoice>().Property(x => x.TransactionSubtotal).HasPrecision(18, 2);
        builder.Entity<SalesInvoice>().Property(x => x.TransactionVatTotal).HasPrecision(18, 2);
        builder.Entity<SalesInvoice>().Property(x => x.TransactionTotal).HasPrecision(18, 2);
        ...
        builder.Entity<SalesInvoiceLine>().Property(x => x.TransactionUnitPrice).HasPrecision(18, 4);
        ...
        builder.Entity<SalesInvoiceLine>().Property(x => x.TransactionNetAmount).HasPrecision(18, 2);
        builder.Entity<SalesInvoiceLine>().Property(x => x.TransactionVatAmount).HasPrecision(18, 2);
        builder.Entity<SalesInvoiceLine>().Property(x => x.TransactionGrossAmount).HasPrecision(18, 2);
...
builder.Entity<SalesInvoiceVoid>()
    ...
    .OnDelete(DeleteBehavior.Restrict);
        ...
        builder.Entity<CustomerReceipt>().Property(x => x.TransactionAmount).HasPrecision(18, 2);
        builder.Entity<CustomerReceipt>().Property(x => x.ExchangeRateToBase).HasPrecision(18, 8);
        builder.Entity<CustomerReceipt>().Property(x => x.RealisedExchangeDifference).HasPrecision(18, 2);
...
builder.Entity<SalesCreditNoteReversal>()
    ...
    .OnDelete(DeleteBehavior.Restrict);
        ...
        builder.Entity<CustomerReceiptAllocation>().Property(x => x.TransactionAmount).HasPrecision(18, 2);
...
builder.Entity<SupplierBillVoid>()
    ...
    .OnDelete(DeleteBehavior.Restrict);
        ...
        builder.Entity<SupplierBillLine>().Property(x => x.TransactionUnitPrice).HasPrecision(18, 4); builder.Entity<SupplierBillLine>().Property(x => x.TransactionNetAmount).HasPrecision(18, 2); builder.Entity<SupplierBillLine>().Property(x => x.TransactionVatAmount).HasPrecision(18, 2); builder.Entity<SupplierBillLine>().Property(x => x.TransactionGrossAmount).HasPrecision(18, 2);
        ...
        builder.Entity<SupplierBillDraft>().Property(x => x.ExchangeRateToBase).HasPrecision(18, 8);
...
builder.Entity<RecurringSupplierBill>()
    .Property(x => x.ExchangeRateToBase)
    .HasPrecision(18, 8);
...
builder.Entity<RecurringSupplierBillGeneration>()
    ...
    builder.Entity<SupplierPayment>().Property(x => x.Amount).HasPrecision(18, 2);
        builder.Entity<SupplierPayment>().Property(x => x.TransactionAmount).HasPrecision(18, 2);
        builder.Entity<SupplierPayment>().Property(x => x.ExchangeRateToBase).HasPrecision(18, 8);
        builder.Entity<SupplierPayment>().Property(x => x.AllocatedBaseAmount).HasPrecision(18, 2);
        builder.Entity<SupplierPayment>().Property(x => x.RealisedExchangeDifference).HasPrecision(18, 2);
        ...
        builder.Entity<SupplierPaymentApproval>().Property(x => x.TransactionAmount).HasPrecision(18, 2);
        builder.Entity<SupplierPaymentApproval>().Property(x => x.ExchangeRateToBase).HasPrecision(18, 8);
        builder.Entity<SupplierPaymentApproval>().Property(x => x.AllocatedBaseAmount).HasPrecision(18, 2);
